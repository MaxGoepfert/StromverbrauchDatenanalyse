...
if __name__ == "__main__":
    ...
    model = xgb.XGBRegressor(objective='reg:squarederror', early_stopping_rounds=50)

    grid_search = GridSearchCV(
    estimator=model,
    param_grid=param_grid,
    scoring='neg_mean_squared_error',  # Change this if you want another metric
    ...
    best_model = xgb.XGBRegressor(**best_params, objective='reg:squarederror', early_stopping_rounds=50)
